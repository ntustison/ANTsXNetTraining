...
weights_filename = scripts_directory + "DeepAtroposHcpT1T2FAWeights.h5"
...
generator = batch_generator(batch_size=batch_size,
                    ...
                    template_modalities=[template_t1, template_t2, template_fa],
...
track = unet_model.fit(x=generator, epochs=20, verbose=1, steps_per_epoch=32,
    callbacks=[
