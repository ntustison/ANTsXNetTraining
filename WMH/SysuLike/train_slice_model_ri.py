...
scripts_directory = base_directory + 'Scripts/SysuLike/'
...
weights_filename = scripts_directory + "wmhSliceSegmentationWeights_ri.h5"
...
track = unet_model.fit(x=generator, epochs=50, verbose=1, steps_per_epoch=50,
    callbacks=[
