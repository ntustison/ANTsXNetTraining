...
unet_model = antspynet.create_unet_model_2d((*template_size, channel_size),
   ...
   convolution_kernel_size=(3, 3), deconvolution_kernel_size=(3, 3),
...
track = unet_model.fit(x=generator, epochs=50, verbose=1, steps_per_epoch=200,
    callbacks=[
...
# sampled_training_wmh_files = list()
...
#     sampled_training_wmh_files.append(training_wmh_files[training_indices[i]])
...
# sampled_validation_wmh_files = list()
...
#     sampled_validation_wmh_files.append(training_wmh_files[validation_indices[i]])
...
#                              wmh_images=sampled_training_wmh_files,
...
#                                     wmh_images=sampled_validation_wmh_files,
