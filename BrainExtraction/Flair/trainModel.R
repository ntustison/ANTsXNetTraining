...
scriptsDirectory <- paste0( baseDirectory, 'ScriptsFlair/' )
...
brainWeightsFileName <- paste0( scriptsDirectory, "/brainExtractionFlairWeights.h5" )
...
brainImages <- list.files( path = brainBaseDataDirectory, pattern = ".*flair.nii.gz", recursive = TRUE, full.names = TRUE )
