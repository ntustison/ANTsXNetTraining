...
baseDirectory <- '/home/ntustison/Data/BrainExtractionFA/'
...
brainWeightsFileName <- paste0( scriptsDirectory, "/brainExtractionFaWeights.h5" )
...
brainBaseDataDirectory <- '/home/ntustison/Data/BrainExtractionFA/Data/'
brainImages <- list.files( path = brainBaseDataDirectory, pattern = "*fa.nii.gz", recursive = TRUE, full.names = TRUE )
