...
base_directory = '/home/ntustison/Data/LobesLabeling/'
...
classes = ['background', 'frontal', 'parietal', 'temporal', 'occipital', 'misc']
...
weights_filename = scripts_directory + "lobesLabeling.h5"
...
training_segmentation_files = glob.glob(data_directory + "T1w*/*dkt_lobes.nii.gz")
...
for i in range(len(training_segmentation_files)):
    image_file = training_segmentation_files[i].replace("dkt_lobes.nii.gz", "extracted.nii.gz")
