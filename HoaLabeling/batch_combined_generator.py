...
def batch_generator(batch_size,
    ...
    while True:
        ...
        while batch_count < batch_size:
            ...
            for ll in range(len(hoa_lateral_right_labels)):
                segmentation[segmentation == hoa_lateral_right_labels[ll]] = hoa_lateral_left_labels[ll]
        ...
        if verbose:
            ...
            if use_multiple_outputs:
                Y2 = np.expand_dims(np.sum(encoded_Y[:,:,:,:,1:20], axis=4), axis=-1)
