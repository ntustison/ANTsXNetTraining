...
base_directory = '/home/ntustison/Data/Mouse/'
...
labels_file = base_directory + "combined_propagated_mask.nii.gz"
...
weights_filename = base_directory + "weights_with_attention_gating.h5"
