...
template_file = base_directory + "TemplateCT/S_template0_sr.nii.gz"
mask_file = base_directory + "TemplateCT/S_template0_sr_mask.nii.gz"
...
mask = antspynet.pad_or_crop_image_to_size(mask, (256, 256, 224))
...
ce_loss = antspynet.weighted_categorical_crossentropy((1, *tuple([100] * (number_of_classification_labels - 1 ))))



weights_filename = "ferretCtBrainExtraction3D.weights.h5"
