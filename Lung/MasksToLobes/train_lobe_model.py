...
base_directory = '/home/ntustison/Data/Lung/MasksToLobes/'
...
weights_filename = scripts_directory + "maskLobeLungWeights.h5"
...
if use_two_outputs:
    ...
    weights_filename = scripts_directory + "maskLobeLungWeights3.h5"
...
lobe_images = glob.glob(base_directory + "Data/Lobes/*.nii.gz")

training_seg_files = list()

for i in range(len(lobe_images)):
    seg_image = lobe_images[i]
    training_seg_files.append(seg_image)

print("Total training image files: ", len(training_seg_files))
