...
priors_directory = base_directory + "Data/LUNA16/PriorsResampledX/"
...
weights_filename = scripts_directory + "lungCtOctantWithPriorsSegmentationWeights.h5"
...
# unet_loss = antspynet.multilabel_dice_coefficient(dimensionality=3, smoothing_factor=0.)
...
ct_images = glob.glob("/home/ntustison/Data/LungCt/Data/LUNA16/NiftiResampledX/*.nii.gz")
...
for i in range(len(ct_images)):
    ct = ct_images[i]
    seg = ct.replace("NiftiResampledX", "seg-lungs-LUNA16-ResampledX")
